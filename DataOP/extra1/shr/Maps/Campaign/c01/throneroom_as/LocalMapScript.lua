...
g_SarayaStandingType = Entities.U_KnightSarayaStanding or Entities.U_Knight_Saraya_TR
...
g_KnightResponses[g_SarayaStandingType]                 = 0
...
g_KnightTypes[g_SarayaStandingType]                 = Entities.U_KnightSaraya
...
g_KnightIds[g_SarayaStandingType]                 = 00
...
g_KnightYaws[g_SarayaStandingType]                 =  20
...
g_KnightEyes[g_SarayaStandingType]                 = 30
...
g_KnightIdles[g_SarayaStandingType]                 = "Idle01_KnightHealing"
...
function Mission_LocalOnMapStart()
	...
	Display.SetExplicitEnvironmentSettings("ThroneRoom_AS.xml")
...
function ThroneRoomStartGameFadeIn()
	...
	local KnightID = 1
	if  g_Throneroom.IngameKnightType == Entities.U_KnightChivalry then KnightID = 3
	elseif  g_Throneroom.IngameKnightType == Entities.U_KnightWisdom then   KnightID = 4
	elseif  g_Throneroom.IngameKnightType == Entities.U_KnightSaraya then   KnightID = 7
    end
