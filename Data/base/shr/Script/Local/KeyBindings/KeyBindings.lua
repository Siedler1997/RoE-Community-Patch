...
function DebugKeyBindings_Init()
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad5, "KeyBindings_CreateBattalionOnMousePositionForActiveGUIPlayer(Entities.U_MilitaryBandit_Melee_NE)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad4, "KeyBindings_CreateBattalionOnMousePositionForActiveGUIPlayer(Entities.U_MilitaryBandit_Ranged_NE)", 2, true)
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "KeyBindings_CreateEntityAtMousePositionForActiveGUIPlayer(Entities.U_MilitaryTrebuchet)", 2, true)
