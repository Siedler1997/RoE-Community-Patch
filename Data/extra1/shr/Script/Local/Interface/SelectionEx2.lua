...
function InitOverwriteConstructionEx2()
    ...
    do
        function GameCallback_GUI_SelectionChanged(_Source)
            ...
            if EntityID ~= nil then
                ...
                elseif EntityType == Entities.U_Helbardier or EntityType == Entities.U_Bear or EntityType == Entities.U_BlackBear or EntityType == Entities.U_PolarBear
                    ...
                    or EntityType == Entities.U_Dog1 or EntityType == Entities.U_Dog2 or EntityType == Entities.U_Dog3
        ...
        --            end
            ...
            if SoundToPlay ~= "" and _Source == g_SelectionChangedSource.User then
