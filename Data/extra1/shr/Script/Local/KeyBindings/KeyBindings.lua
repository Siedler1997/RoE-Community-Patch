...
function DebugKeyBindings_Init()
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad8, "GUI_Construction.BuildWallClicked(UpgradeCategories.NPC_Cloister_AS_WallSegment)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "GUI_Construction.BuildWallGateClicked(UpgradeCategories.FenceGate)", 2, true)
    --Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "GUI_Construction.BuildWallClicked(UpgradeCategories.NPC_Cloister_NA_WallSegment)", 2, true)
