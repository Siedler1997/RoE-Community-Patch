...
function DebugKeyBindings_Init()
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad8, "GUI_Construction.BuildWallClicked(UpgradeCategories.FenceGate)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "GUI_Construction.BuildWallClicked(UpgradeCategories.FenceSegment)", 2, true)
