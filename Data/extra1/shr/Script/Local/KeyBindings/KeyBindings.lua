...
function DebugKeyBindings_Init()
    ...
    --Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "KeyBindings_CreateEntityAtMousePositionForActiveGUIPlayer(Entities.B_Beautification_Standarte)", 2, true)
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad4, "GUI_Construction.BuildClicked(UpgradeCategories.Beautification_Plaza_ME)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad5, "GUI_Construction.BuildClicked(UpgradeCategories.Beautification_Plaza_NE)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad6, "GUI_Construction.BuildClicked(UpgradeCategories.Beautification_Plaza_SE)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad7, "GUI_Construction.BuildClicked(UpgradeCategories.Beautification_Plaza_NA)", 2, true)
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "GUI_Construction.BuildClicked(UpgradeCategories.Beautification_Knight_Saraya)", 2, true)
