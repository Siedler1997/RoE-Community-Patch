...
function DebugKeyBindings_Init()
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad6, "KeyBindings_CreateEntityAtMousePositionForActiveGUIPlayer(Entities.U_MilitaryStandarte)", 2, true)
    ...
    Input.KeyBindDown(Keys.ModifierControl + Keys.NumPad9, "KeyBindings_CreateEntityAtMousePositionForActiveGUIPlayer(Entities.U_CatapultCart)", 2, true)
