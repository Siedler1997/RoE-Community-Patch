...
function InitLocalOverwrite()
    ...
    do 
        ...
        InitTexturePositions = function()
            ...
            -- Goods
            g_TexturePositions.Goods[Goods.G_Salt] =  {1, 1, 1}
...
function InitMultiselection()
    ...
    LeaderSortOrder[36] = Entities.U_Tiger_White
    LeaderSortOrder[37] = Entities.U_Cat
    LeaderSortOrder[38] = Entities.U_Dog
end
