...
-- Gibt die EntityId eines feindlichen Marktplatzes in der Naehe zurueck
...
-----------------------------------------------------------------------------------------
-- Overwrites for Knight
-----------------------------------------------------------------------------------------

function InitOverwriteKnightEx2()
    ...
    do 
        local GUI_Knight_OldGetKnightAbilityAndIcons = GUI_Knight.GetKnightAbilityAndIcons
        function GUI_Knight.GetKnightAbilityAndIcons(_KnightID)
            ...
            if KnightType == Entities.U_KnightChivalry or KnightType == Entities.U_KnightKhana then
            ...
            elseif KnightType == Entities.U_KnightRedPrince then
                ...
                return GUI_Knight_OldGetKnightAbilityAndIcons(_KnightID)
            end
        ...
        function GUI_Knight.StartAbilityClicked(_Ability)
            ...
            elseif Logic.GetEntityType(KnightID) == Entities.U_KnightRedPrince then
                ...
                if MarketplaceID > 0 then
                    ...
                    -- Nur moeglich, wenn der Gegner mindestens Baron ist und somit Zugang zur Apotheke hat
                    if Logic.GetKnightTitle(EnemyPlayerId) >= 2 then
                        ...
                        for i = 1, #Buildings/2 do
                            -- Bis zu 50% der Gebaeude koennen befallen werden
