...
function RemoveTraitorFromThroneRoom()
    ...
    Logic.ExecuteInLuaLocalState("RemoveTraitorFromThroneRoom()")
...
function StopAllAnimations()
	...
	PlayAnimation(Entities.U_KnightPlunderStanding,"Idle01","Idle01_KnightPlunder")

	PlayAnimation(Entities.U_KnightWisdomStanding,"Idle01","Idle01_KnightWisdom")
	PlayAnimation(Entities.U_KnightSongStanding,"Idle01","Idle01_KnightSong")

	PlayAnimation(Entities.U_KnightChivalryStanding,"Idle01","Idle01_KnightChivalry")
	PlayAnimation(Entities.U_KnightHealingStanding,"Idle01","Idle01_KnightHealing")
...
function Mission_FirstMapAction()
	...
	Logic.CreateEntity(Entities.ThroneRoom_Cube,mapX,mapY,0,0)
