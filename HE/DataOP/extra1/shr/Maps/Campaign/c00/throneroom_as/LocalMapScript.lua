...
g_MissionTexts = {}
g_MissionTexts.Title = "Challia"
g_MissionTexts.Objectives = "Mission: {cr}Choose a knight and send him to Challia to erect our first city in this area. {cr}Your knight must upgrade his castle to become EARL / COUNTESS of Challia. {cr}Try to make Zaanmaar village our ally to strenghten our influence in this area. {cr}{cr}Hints: {cr}There are two villages and a city nearby which are currently neutral towards our plans. The city wants to expand, so you'll face a conflict if you claim territories nearby. {cr}If a village asks for help, you can make it our ally by supporting it. Otherwise the villagers attitude gets worse and they start to steal from your settlers or support the bandits."
g_VoiceId = ""
g_CampaignMaps = {  "c00_m01_Vestholm",
                    "c00_m02_Challia",
                    "c00_m03_Gallos",
                    "c00_m04_Narfang",
                    "c00_m05_Drengir",
